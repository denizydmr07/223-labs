...
HD_PWD='/home/deniz/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficLights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TrafficLights.tcl
