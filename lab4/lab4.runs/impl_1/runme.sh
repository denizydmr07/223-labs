...
HD_PWD='/home/deniz/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrafficLights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TrafficLights.tcl -notrace
