...
HD_PWD='/home/deniz/lab_5_2/lab_5_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SR8A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SR8A.tcl -notrace
