...
HD_PWD='/home/deniz/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_Calculator_Structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_Calculator_Structural.tcl
