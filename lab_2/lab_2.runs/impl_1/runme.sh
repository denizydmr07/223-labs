...
HD_PWD='/home/deniz/lab_2/lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_Calculator_Structural.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_Calculator_Structural.tcl -notrace
